...
public class Households {
	...
	static public LogNormalDistribution buyToLetDistribution  = new LogNormalDistribution(Math.log(3.44), 1.050); // No. of houses owned by buy-to-let investors Source: ARLA review and index Q2 2014

	// House price reduction behaviour. Calibrated against Zoopla data at BoE
	static public double P_SALEPRICEREDUCE = 0.944; 	// monthly probability of reducing the price of house on market
